...
const styles = StyleSheet.create({
  ...
  headerTitle:   { fontSize: 22, fontWeight: '800', color: Colors.brand, letterSpacing: -0.5 },
  ...
  summaryCard:   { margin: 16, backgroundColor: Colors.card, borderRadius: 16, padding: 20, borderWidth: 1, borderColor: Colors.cardBorder },
  summaryRow:    { flexDirection: 'row' },
  summaryItem:   { flex: 1 },
  summaryLabel:  { fontSize: 11, color: Colors.textMuted, marginBottom: 4, fontWeight: '500', textTransform: 'uppercase', letterSpacing: 0.5 },
  ...
  sectionLabel:  { fontSize: 11, fontWeight: '600', color: Colors.textMuted, letterSpacing: 1, paddingHorizontal: 16, marginBottom: 8 },
  ...
  platform:      { fontSize: 11, color: Colors.textMuted, textTransform: 'uppercase', fontWeight: '600', letterSpacing: 0.5 },
  cardRow:       { flexDirection: 'row' },
  statLabel:     { fontSize: 11, color: Colors.textMuted, marginBottom: 3, fontWeight: '500' },
  statValue:     { fontSize: 16, fontWeight: '700', color: Colors.text },
  posCount:      { marginTop: 12, backgroundColor: Colors.brandDim, borderRadius: 6, paddingHorizontal: 10, paddingVertical: 5, alignSelf: 'flex-start' },
  posCountText:  { fontSize: 12, color: Colors.brand, fontWeight: '600' },
});
